...
function useForm(initalRecord, {html2js}, {isValid, errorMessage}, onSubmit){
//Initialisation ------------------------------

//State ---------------------------------------
const [record, setRecord] = useState(initalRecord);
const [errors, setErrors] = useState(
    Object.keys(isValid).reduce((accum,key) =>
        ({...accum, [key]: null}),{})
);
...
//View ----------------------------------------
return (
	[record, errors, handleChange, handleSubmit]
);
}
